...
torch.save(model.state_dict(), 'RNN_NER_W2V.pt')
...
plt.savefig('RNN_NER_W2V.png')

model = VanillaRNN(embedding_dim, hidden_dim, output_dim)
model.load_state_dict(torch.load('RNN_NER_W2V.pt'))
model.eval()
