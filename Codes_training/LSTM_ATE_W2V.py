...
torch.save(model.state_dict(), 'lstm_ate_w2v.pt')
...
model = LSTMModel(embedding_dim, hidden_dim, output_dim)
model.load_state_dict(torch.load('lstm_ate_w2v.pt'))
model.eval()
